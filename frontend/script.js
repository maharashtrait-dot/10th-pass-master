...
/* STEP 104 — FINAL LOGIN FIX
   Use the project's original createStudent() login flow only.
   Do not intercept/replace it with alternate endpoints.
*/
document.addEventListener("DOMContentLoaded", function () {
    const btn = document.getElementById("startStudyButton");
    if (btn) {
        btn.type = "button";
        btn.onclick = null;
